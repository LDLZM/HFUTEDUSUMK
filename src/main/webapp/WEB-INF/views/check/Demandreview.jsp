...
<body>
<div class="container">
  <h2>审核采购需求 #${demand.demandId}</h2>

  <form action="${pageContext.request.contextPath}/check/processDemandreview" method="post">
    <input type="hidden" name="demandId" value="${demand.demandId}">

    <div class="form-group">
      <label>商品名称:</label>
      <p>${demand.product.name}</p>
    </div>
...
<%--    </div>--%>
  ...
  <a href="${pageContext.request.contextPath}/check/Demandlist" class="back-link">返回列表</a>
</div>
